...
<div class="p-6">
  ...
  <div class="max-w-xl space-y-6">
    ...
    {:else}
      <div>
        <label class="block text-xs text-surface-500 mb-1">Issuer URL</label>
        <input
          type="url"
      ...
      <div>
        <label class="block text-xs text-surface-500 mb-1">Client ID</label>
        <input
          type="text"
          bind:value={clientId}
      ...
      <div>
        <label class="block text-xs text-surface-500 mb-1">Groups Claim</label>
        <input
          type="text"
